...
<head>
    ...
    <?php endforeach; ?>
    <style>html body [id^="maxkb-"] .maxkb-chat-button{position:fixed!important;bottom:auto!important;top:50%!important;right:10px!important;transform:translateY(-50%)!important;z-index:10001!important}html body [id^="maxkb-"] #maxkb-chat-container{position:fixed!important;bottom:auto!important;top:50%!important;right:80px!important;transform:translateY(-50%)!important;width:460px!important;height:680px!important}html body [id^="maxkb-"] .maxkb-tips{right:80px!important;bottom:auto!important;top:50%!important;transform:translateY(-50%)!important}html body [id^="maxkb-"] .maxkb-tips .maxkb-arrow{right:-5px!important;left:auto!important;bottom:auto!important;top:50%!important;transform:translateY(-50%) rotate(45deg)!important}@media only screen and (max-width:768px){html body [id^="maxkb-"] #maxkb-chat-container{width:85vw!important;height:80vh!important;right:70px!important}}.maxkb-chat-button{width:72px!important;height:72px!important}.maxkb-chat-button img{object-fit:contain}</style>
